const fileMap = {
  ...
  "renders": [
    "x2.png",
    "aq.png",
    "Screenshot 2025-05-06 at 20.06.07.png",
    "x copy.png",
    "1af.png",
    "x3.png",
    "3af.png",
    ...
    "d4.png",
    "cccc.png",
    "Screenshot 2025-05-06 at 20.05.04.png",
    "z10.png",
    "x12.png",
    "www.png",
    "b4.png",
    ...
    "z11.png",
    "w7.png",
    "Screenshot 2025-05-06 at 20.06.19.png",
    "w.png",
    "az.png",
    "w6.png",
    "ww.png",
  ...
  fetch('files/' + folder + '/')
    ...
    .then(html => {
      ...
      links.forEach(link => {
        ...
        li.innerHTML = '<a href="' + link.href + '" target="_blank" onclick="event.preventDefault(); viewFile(\'' + link.href + '\')">' + link.text + '</a>';
        list.appendChild(li);
      });
    });
}
...
function loadFiles() {
  ...
  fileMap[folder].forEach(filename => {
    const fileUrl = `files/${folder}/${filename}`;
    const li = document.createElement("li");
    li.innerHTML = `<a href="${fileUrl}" target="_blank" onclick="event.preventDefault(); viewFile('${fileUrl}')">${filename}</a>`;
    list.appendChild(li);
  });
}
